...
stubs: all 21 levels (tutorial + 20, × easy/hard) are playable start to
...
Rounds 1–14 are **done** — the table below is complete; there is no
...
npm test            # 44 tests must stay green
